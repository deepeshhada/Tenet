...
class Tenet_Gnn_Seq(torch.nn.Module):
    def __init__(self,params,device='cuda:0'):
        super(Tenet_Gnn_Seq,self).__init__()
        print("Method: ", params.method.upper() +'_GNN_SEQ')
        self.params                      = params
        ...
        # transormer model ======================
        self.trans_model                     = TransformerModelMine(ntoken=params.num_item, ninp=params.hid_units[-1], nhead=params.n_heads[-1],
