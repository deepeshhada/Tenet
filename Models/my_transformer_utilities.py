...
#from TransformerModelMine import TransformerModelMine
import copy
...
# ===============================================================================
## task is to set activation function to none
class MultiheadAttention(Module):
    ...
    def __init__(self, embed_dim, num_heads, dropout=0., bias=True, add_bias_kv=False, add_zero_attn=False, kdim=None, vdim=None):
        ...
        self._qkv_same_embed_dim = self.kdim == embed_dim and self.vdim == embed_dim ##what is happening here 
