...
def run_python(test,lr,batch_size,num_factors,num_negatives,margin,keep_prob,gnn_keep_prob,net_keep_prob,hid_units,d_k,n_heads,knn_k):
    sys_path         = '/home/vijai/'
    #data_path        = 'tenet/data_tenet/required/spotify_small/tenet/spotify/' #+ test + '/fold1/'
    data_path        = 'tenet/data_tenet/embed_required/zhihu_small/tenet/zhihu/' #+ test + '/fold1/'
    ...
    res_folder       = 'training_hgnn/' # 'training_negative' ,'training_knn'
    comment          = 'training gcn-gmf on music.'
    ...
    print("\n")
    #'''
    #subprocess.call(['python','seq_mine_Main.py', ##
    #subprocess.call(['python','Main_Both.py', ##
    subprocess.call(['python','Main_Both2.py', ##
...
if __name__ == '__main__':
    ...
    d_k_list            = ['64']
    n_heads_list        = ['[4,2]']
    knn_k_list          = ['50']  #['5','10','15','25','30','40','50']
